...
namespace Photoshop.Models
{
    ...
    public class Huffman<T> where T : IComparable
    {
        ...
        public static byte[] Compression(Bitmap bitmap)
        {
            ...
            byte[,] niz = new byte[b.Width,b.Height*3];
        ...
        public Huffman(IEnumerable<T> values)
        {
            ...
            var priorityQueue = new HuffmanCode.PriorityQueue<HuffmanNode<T>>();
            int valueCount = 0;
